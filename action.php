...
//Подключаемся к БД
mysql_connect("localhost", "m32sa", "lovelust");
mysql_select_db("Buzzfactory");
    ...
    switch ($section) {     
        case 'files': 
            ...
            $album = new Album($_REQUEST, array(
                'tableName'    => 'uploader',
                'files'        => array(
                    array('field' => 'original', 'dir' => 'Images/files_original/', 'fit' => true,      'width' => 1200, 'height' => 1200, 'ext' => 'jpg'),
                    array('field' => 'image',    'dir' => 'Images/files_image/',    'fit' => 'contain', 'width' => 800,  'height' => 800,  'ext' => 'jpg'),
                    array('field' => 'thumb',    'dir' => 'Images/files_thumb/',    'fit' => 'cover',   'width' => 160,  'height' => 160,  'ext' => 'png')
                ),
                'maxSize'          => '4M',
                'maxSpace'         => '100M',
        ...
        default: throw new Exception('Can\'t get action type', 15);
    }
