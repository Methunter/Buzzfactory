...
try {
    switch ($section) {     
        ...
        default: throw new Exception('Action type isn\'t set', 15);
    }
...
class Album {
    ...
    public $prm = array(
        'tableName' => 'uploader', //Имя таблицы в БД
        'files'     => array(array(//В первом поле настройки для оригинала
            'field'     => 'files_original',  //Поле в БД для хранения имени файла
            'dir'       => 'Images/', //Папка, куда загружаются файлы
            'fit'       => 'cover',
            'width'     => 160,
            'height'    => 160,
            'ext'       => 'jpg',
