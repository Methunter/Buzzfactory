...
!1},_transitionEnd:function(a,c){Metro_Gallery._use_css_animation?(transEndEventNames="webkitTransitionEnd oTransitionEnd MSTransitionEnd transitionend",a.on(transEndEventNames,function(b){a.off(transEndEventNames);c(b,a)})):c(null,a);return a},_init:function(){if(!Metro_Gallery._loaded){Metro_Gallery._css3SupportDetect();$(document.body).addClass("loaded");Metro_Gallery._cache_elements();Metro_Gallery._buildStyles();Metro_Gallery._build();var a=Metro_Gallery._configs.base_size+Metro_Gallery._configs.gutter,
c=Metro_Gallery._tiles.eq(0),b=c.attr("class").split(" ");$(b).each(function(b,e){if(-1!==e.indexOf("tile_")){var h=e.replace(/tile_/,"").substr(0,1),g=parseInt(c.css("margin-right"),10);a=(c.width()+2*g-2*g*h)/h+2*g;return!1}});Metro_Gallery._containers.each(function(){var b=$(this);b.hasClass("vertical")||b.hasClass("horizontal")||b.addClass("vertical");var c=new Masonry(b.get(0),{itemSelector:".tile",columnWidth:a,transitionDuration:"0.7s"});b.data("msnry",c)});Metro_Gallery._tiles.each(function(a){var b=
...
break;case 37:Metro_Gallery.Events.lightboxPrevClick(a);break;case 39:Metro_Gallery.Events.lightboxNextClick(a)}},prevClick:function(a){a.preventDefault();Metro_Gallery._goNext($(this).data("tile"),"back")},nextClick:function(a){a.preventDefault();Metro_Gallery._goNext($(this).data("tile"),"next")},lightboxPrevClick:function(a){a&&a.preventDefault();0===Metro_Gallery._image_pointer?Metro_Gallery._image_pointer=Metro_Gallery._images.length-1:Metro_Gallery._image_pointer--;Metro_Gallery._images.eq(Metro_Gallery._image_pointer).click()},
lightboxNextClick:function(a){a&&a.preventDefault();Metro_Gallery._image_pointer===Metro_Gallery._images.length-1?Metro_Gallery._image_pointer=0:Metro_Gallery._image_pointer++;Metro_Gallery._images.eq(Metro_Gallery._image_pointer).click()},imageClick:function(a){var c=$(this);a=c.data("link");"img"===c.prop("tagName").toLowerCase()&&(a?window.open(a,"_blank"):c.parents(".metro_gallery").hasClass("lightbox")&&(Metro_Gallery._images.each(function(a){if($(this).get(0)===c.get(0))return Metro_Gallery._image_pointer=
a,!1}),Metro_Gallery._openLightbox(c)))},onSwipeLeft:function(a){Metro_Gallery._overlay&&Metro_Gallery._lightbox&&Metro_Gallery.Events.lightboxPrevClick()},onSwipeRight:function(a){Metro_Gallery._overlay&&Metro_Gallery._lightbox&&Metro_Gallery.Events.lightboxNextClick()}}};setTimeout(Metro_Gallery._init,5E3);$(window).load(Metro_Gallery._init);